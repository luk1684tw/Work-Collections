...
const QMetaObject chariot::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_chariot.data,
      qt_meta_data_chariot,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *chariot::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_chariot.stringdata0))
        return static_cast<void*>(const_cast< chariot*>(this));
